...
const Products = () => {
  ...
  return (
    <section className=" w-full h-full flex flex-col">
      ...
      <div className="flex flex-wrap mt-8 gap-5 overflow-y-auto ">
        <Card />

        {products.map((product, index) => (
          <>
            <div className="flex bg-white flex-col justify-start shadow-md rounded-2xl  max-w-[190px] h-[280px] overflow-hidden mb-5">
        ...
        <div
          className="flex justify-center items-center bg-white flex-col cursor-pointer shadow-md rounded-2xl  w-[190px] h-[280px] overflow-hidden text-lg font-bold"
        ...
        {showAddProductPage && (
          <NewProductPage onClose={handleCloseAddProductPage} />
        )}
      </div>
    </section>
  );
