...
const CurrentOffer = () => {
  return (
    <div className="w-full h-full whitespace-pre-wrap capitalize flex justify-start items-center  bg-gradient-to-r from-[#181818] to-[#363636]">
      <div className="w-[70%] h-full p-[25px] flex flex-col items-start justify-between leading-relaxed ">
        <h1 className=" text-[20px] text-white">current offers</h1>
        <p className="py-3 text-[10px] font-semibold text-white">
